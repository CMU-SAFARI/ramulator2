...
import ramulator
from ramulator._ramulator import _ControllerUnderTest as _CppControllerUnderTest
from ramulator._validation_common import _metadata_from_dram
from ramulator._validation_common import _request_type_ids
    ...
    def make_generic_ddr(
        ...
        **kwargs,
        ...
        controller = ramulator.controller.GenericDDR(
            ...
            addr_mapper=addr_mapper or ramulator.addr_mapper.DirectMapper(),
            dram=dram,
